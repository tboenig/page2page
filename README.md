...
Attention
-------------------------------
The transformation is not a conversation into PAGE XML. This transformation deletes the proprietary Transkribus elements the first time. Important information in custom attributes is not converted to type values. An example:
